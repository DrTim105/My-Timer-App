...
import com.salihutimothy.mytimerapp.AppConstants
import com.salihutimothy.mytimerapp.MainActivity
import com.salihutimothy.mytimerapp.R
import com.salihutimothy.mytimerapp.TimerNotificationActionReceiver
    ...
    companion object {
        ...
        fun showTimerExpired(context: Context) {
            ...
            nBuilder.setContentTitle("Timer Expired!")
                ...
                .addAction(R.drawable.ic_placeholder, "Start", startPendingIntent)
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long) {
            ...
            nBuilder.setContentTitle("Timer is Running.")
                ...
                .setContentIntent(getPendingIntentWithStack(context, MainActivity::class.java))
                .setOngoing(true)
                .addAction(R.drawable.ic_placeholder, "Stop", stopPendingIntent)
                .addAction(R.drawable.ic_placeholder, "Pause", pausePendingIntent)
        ...
        fun showTimerPaused(context: Context) {
            ...
            nBuilder.setContentTitle("Timer is paused.")
                ...
                .setContentIntent(getPendingIntentWithStack(context, MainActivity::class.java))
                .setOngoing(true)
                .addAction(R.drawable.ic_placeholder, "Resume", resumePendingIntent)
        ...
        private fun NotificationManager.createNotificationChannel(
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                nChannel.vibrationPattern = pattern
